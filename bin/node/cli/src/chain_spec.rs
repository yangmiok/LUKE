...
/// luke net generator
pub fn luke_chain_config() -> Result<ChainSpec, String> {
	ChainSpec::from_json_bytes(&include_bytes!("../res/lukeSpecRaw.json")[..])
}
...
pub fn testnet_genesis(
	...
	let mut endowed_accounts: Vec<AccountId> = endowed_accounts.unwrap_or_else(|| {
		vec![
			...
			hex!["360e2ca0caf0e8c03c47542efdfec99de21cb79aebdf683c7c51a85c6d7bd35b"].into(),
		]
	});
	...
	const ENDOWMENT: Balance = 4 * DOLLARS;
	const STASH: Balance = ENDOWMENT / 4;
