...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("LUKE"),
    impl_name: create_runtime_str!("LUKE-node"),
...
parameter_types! {
    ...
    pub const SS58Prefix: u16 = 11921;
}
...
parameter_types! {
    ...
    pub const OnePFouSixbil:Balance =   18_6000_0000;
